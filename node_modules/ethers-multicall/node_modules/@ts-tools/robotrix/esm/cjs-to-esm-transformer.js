 ...
 */
export function createCjsToEsmTransformer(options = {}) {
...
function transformSourceFile(sourceFile, context, { shouldTransform = () => true }) {
    ...
    function visitCommonJS(node) {
        if (ts.isFunctionLike(node) &&
            ...
            newImports.push(ts.createImportDeclaration(undefined /* decorators */, undefined /* modifiers */, ts.createImportClause(importIdentifier, undefined /* namedBindings */), node.arguments[0]));
...
function createCjsModuleDefinition() {
    return ts.createVariableStatement(undefined /* modifiers */, ts.createVariableDeclarationList([
        ...
        ts.createVariableDeclaration('module', undefined /* type */, ts.createObjectLiteral([ts.createShorthandPropertyAssignment('exports')]))
    ], ts.NodeFlags.Let));
}
