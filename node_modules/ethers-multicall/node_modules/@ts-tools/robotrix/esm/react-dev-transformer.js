 ...
 */
export function reactDevTransformer(context) {
    return sourceFile => {
...
function createLocationObject(jsxFileNameIdentifier, line) {
    return ts.createObjectLiteral([
        ts.createPropertyAssignment('fileName', jsxFileNameIdentifier // use the file-wide identifier for fileName value
        ),
...
function addFileNameConst(sourceFile, jsxFileNameIdentifier, fileName) {
    ...
    return insertStatementAfterImports(sourceFile, ts.createVariableStatement(undefined /* modifiers */, ts.createVariableDeclarationList(variableDecls, ts.NodeFlags.Const)));
}
