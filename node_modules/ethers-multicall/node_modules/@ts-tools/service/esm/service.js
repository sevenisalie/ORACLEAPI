...
import { createBaseHost, createCustomFsBaseHost, createLanguageServiceHost, createCustomFsLanguageServiceHost } from './create-host';
/**
...
export class TypeScriptService {
    ...
    transpileFile(filePath, transpileOptions) {
        ...
        const { errors, fileNames, options: tsconfigOptions } = ts.parseJsonSourceFileConfigFileContent(jsonSourceFile, baseHost, configDirectoryPath);
        if (errors.length) {
            return {
                diagnostics: errors,
                filePath,
    ...
    transpileIsolated(filePath, baseHost, options) {
        ...
        const { outputText, diagnostics, sourceMapText } = ts.transpileModule(tsCode, { compilerOptions, transformers, fileName: filePath });
        return {
            filePath,
            outputText,
            sourceMapText,
